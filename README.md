...
> **О проекте.** Это учебный pet-проект, реализованный по практическому видеоуроку Youtube канала [JavaScript Mastery](https://youtu.be/lEflo_sc82g?si=JWp6Dlk0Li1jVMgN). Идея, архитектура и основной сценарий взяты из курса; код написан и доработан мной в процессе обучения.
...
- Подтверждение или отмена записи администратором (schedule / cancel)
- Email-уведомления пациенту при подтверждении или отмене приёма (через Appwrite Messaging)
...
1. Откройте главную страницу. Под формой логина нажмите на кнопку Admin
